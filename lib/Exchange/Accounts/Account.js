...
function () {
  function Account(_ref) {
    ...
    var dolomite_account_id = _ref.dolomite_account_id,
        ...
        margin_details = _ref.margin_details;
    ...
    var _ref3 = margin_details || {},
        is_local_operator_set = _ref3.is_local_operator_set;
  ...
  _createClass(Account, [{
    ...
    key: "generate",
    value: function generate(walletAddress) {
      var tier = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4;
...
var LoginRequest = function LoginRequest(_ref4) {
  var token = _ref4.token,
      is_2fa_required = _ref4.is_2fa_required,
      verification_method = _ref4.verification_method;
