  ...
  _createClass(VerificationService, [{
    ...
    value: function repairAccount(_ref4) {
      var accountId = _ref4.accountId,
          ...
          prepareMessage = _ref4.prepareMessage;
    ...
    value: function linkExternalAccount(accountId, wyreSecret) {
    ...
    value: function upgradeToTier4(_ref8) {
      var accountId = _ref8.accountId,
          ...
          prepareMessage = _ref8.prepareMessage;
    ...
    key: "changeEmail",
    value: function changeEmail(email, accountId, shouldUseWyreAuth) {
      var params = {
        email: email,
        account_id: accountId
      };
      var changeEmailRoute = 'changeEmail';
