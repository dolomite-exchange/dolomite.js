...
function (_Service) {
  ...
  _createClass(AddressService, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(ownerAddress, brokerAddress) {
    ...
    value: function onPortfolioUpdate(callback) {
      ...
      this.on('/v1/addresses/-address-/portfolio', 'update').then(function () {
        _this.getPortfolio(_this.watched.ownerAddress, _this.watched.brokerAddress).then(function (portfolio) {
      ...
      if (!this.portfolioWS) this.portfolioWS = new _WSWrapper["default"](function () {
        if (!_this.watched.ownerAddress) return null;
        return _this.getPortfolio(_this.watched.ownerAddress, _this.watched.brokerAddress);
