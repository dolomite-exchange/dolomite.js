...
function () {
  function Market(_ref) {
    var market = _ref.market,
        ...
        index_price_usd = _ref.index_price_usd,
        ...
        primary_ticker_decimal_places = _ref.primary_ticker_decimal_places,
        secondary_ticker_price_decimal_places = _ref.secondary_ticker_price_decimal_places,
    ...
    this.indexPrice = new _BigNumber["default"](index_price_usd);
    ...
    this.isHidden = is_hidden; // Deprecated
