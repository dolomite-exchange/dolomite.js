...
var OrderDepth = /*#__PURE__*/function () {
  ...
  _createClass(OrderDepth, null, [{
    ...
    value: function merge(price, orders) {
      ...
      var totalOpenPrimaryUnpadded = sum(orderedOrders, function (order) {
        return order.openAmountPrimary.value;
      });
      var totalOpenSecondaryUnpadded = sum(orderedOrders, function (order) {
        return order.openAmountSecondary.value;
      });
