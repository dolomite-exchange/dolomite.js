...
function () {
  function Order(_ref) {
    ...
    if (this.tradeType === 'MARGIN') {
      this.depositPaddedAmount = new _BigNumber["default"](margin_order_data.deposit_padded_amount);
      this.isMarginOpen = this.depositPaddedAmount === new _BigNumber["default"](0);
      ...
      if (margin_order_data.deposit_precisioned_ticker.ticker === this.primaryToken.ticker) {
        ...
        this.leverage = this.isMarginOpen ? this.amountB / this.depositPaddedAmount : new _BigNumber["default"](0);
      } else {
        this.marginActionType = this.isMarginOpen ? 'CLOSE_SHORT' : 'OPEN_SHORT';
        this.leverage = this.isMarginOpen ? this.amountB / this.depositPaddedAmount - new _BigNumber["default"](1) : new _BigNumber["default"](0);
      }
