...
function (_Service) {
  ...
  _createClass(OrderService, [{
    ...
    key: "watchDepthChart",
    value: function () {
      var _watchDepthChart = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(market) {
    ...
    key: "watchFills",
    value: function () {
      var _watchFills = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(market) {
