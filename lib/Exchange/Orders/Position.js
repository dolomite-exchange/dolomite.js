...
function () {
  function Position(_ref) {
    ...
    var dolomite_position_id = _ref.dolomite_position_id,
        ...
        liquidation_price_amount = _ref.liquidation_price_amount,
    ...
    this.positionSize = this.type === 'LONG' ? this.targetHeldAmount : this.targetHeldAmount.calc(function (a) {
      return a - _this.targetDepositAmount.val;
    });
