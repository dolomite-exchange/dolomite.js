...
function (_Array) {
  ...
  function PortfolioGraph(_ref) {
    ...
    var currency = _ref.currency,
        time_price_pairs = _ref.time_price_pairs,
        period = _ref.period;

    _classCallCheck(this, PortfolioGraph);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(PortfolioGraph).call(this));
    _this.currency = currency;
    _this.period = period;
    var data = (time_price_pairs || []).map(function (point) {
      return {
        timestamp: point.timestamp,
        price: _BigNumber["default"].build(point.value, currency.precision)
      };
    });
