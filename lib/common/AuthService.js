...
function (_Service) {
  ...
  _createClass(AuthService, [{
    ...
    key: "withWyreAuth",
    value: function withWyreAuth(method, routeName, options) {
      var _this2 = this;
      ...
      return function (resource, params) {
        ...
        var callback = function callback() {
          return _this2.getAuthToken(true, getPrepareMessage).then(function (_ref) {
            ...
            return method(resource, _objectSpread((_objectSpread2 = {}, _defineProperty(_objectSpread2, options.addressKey, address), _defineProperty(_objectSpread2, options.accountIdKey, accountId), _objectSpread2), authSigParams, params), _objectSpread({}, headers, {
              Authorization: token
            }));
          });
        };
